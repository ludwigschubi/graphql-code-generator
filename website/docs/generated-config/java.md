...
<img alt="java plugin version" src="https://img.shields.io/npm/v/webql-codegen-java?color=%23e15799&label=plugin&nbsp;version&style=for-the-badge"/>


    
:::shell Using `yarn`
    yarn add -D webql-codegen-java
:::
