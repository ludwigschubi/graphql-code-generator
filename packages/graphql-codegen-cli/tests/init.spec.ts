...
describe('init', () => {
  ...
  it('should use angular related plugins when @angular/core is found', async () => {
    ...
    expect(pkg.devDependencies).toHaveProperty('webql-codegen-typescript-apollo-angular');
  ...
  it('should use stencil related plugins when @stencil/core is found', async () => {
    ...
    expect(pkg.devDependencies).toHaveProperty('webql-codegen-typescript');
    expect(pkg.devDependencies).toHaveProperty('webql-codegen-typescript-operations');
    expect(pkg.devDependencies).toHaveProperty('webql-codegen-typescript-stencil-apollo');
    // should not have other plugins
    expect(Object.keys(pkg.devDependencies)).toHaveLength(4);
  });
  ...
  it('should use typescript related plugins when typescript is found (node)', async () => {
    ...
    // expected plugins
    expect(pkg.devDependencies).toHaveProperty('webql-codegen-typescript');
    expect(pkg.devDependencies).toHaveProperty('webql-codegen-typescript-resolvers');
    // should not have other plugins
  ...
  it('custom setup', async () => {
    ...
    expect(pkg.devDependencies).not.toHaveProperty('webql-codegen-typescript-resolvers');
  ...
  describe('plugins', () => {
    ...
    plugins.forEach(pkg => {
      ...
      expect(pkg.package.replace('webql-codegen-', '')).toEqual(pkg.value);
